...
class Content extends Component {
  ...
  render() {
    ...
    return (
      <>
        <h5 className="mr-auto ml-[165px]">
          <span className="opacity-[0.25] mr-[28px]">03</span>
          SPACE LAUNCH 101
        </h5>
        <div className="flex items-center justify-end">
          <div className="max-w-[1275px] w-full flex items-end justify-end pl-5">
            <div className=" flex justify-between items-center gap-10 mt-[26px]">
